...
이 문서는 `urban-prototyping-coach`가 어떤 기준에서 현재 모습을 갖게 되었는지 짧게 정리한 정렬 표면입니다.
...
| `generate-skill` | working SoT, runtime compatibility, fixed/flexible/decisional, validation contract | `Working Source of Truth`, `Runtime Compatibility Gate`, `3층 분류`, `Preflight and Validation` |
